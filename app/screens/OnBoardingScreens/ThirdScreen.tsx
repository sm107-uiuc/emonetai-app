...
interface ThirdScreenProps extends AppStackScreenProps<"Profile"> {}

export const ThirdScreen: FC<ThirdScreenProps> = observer(function ThirdScreen(
    ...
    >
      <View>
        ...
        >
          ...
          />
          <Text style={$headerText}>Schedule Journaling Calls</Text>
          <Text style={$captionText}>
            Stay committed with <Text style={$boldText}>scheduled journaling calls.</Text> Set
          </Text>
          <Text style={$captionText}>reminders for regular voice journaling sessions.</Text>
        </View>
        ...
        <TouchableOpacity style={$buttons} onPress={goNext}>
